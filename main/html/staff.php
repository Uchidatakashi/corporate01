...
<html lang="ja">
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1">
		 <!--ページタイトル ここから -->
		<title>院長・スタッフ | Dental Clinic</title>
		 <!--ページタイトル ここまで -->
		...
		<div id="wrapper">
			...
			<div id="contentsWrapper">
				<div id="contents" class="clearFix">
					<!-- パンくずリスト ここから -->
					<div class="panList"><a href="index.php">トップページ</a> &gt; 院長・スタッフ紹介</div>
					<!--<div class="panList"><a href="index.php">トップページ</a> &gt; 医院紹介</div>-->
					<!-- パンくずリスト ここまで -->
						...
						<div class="inner">
							...
							<div class="doctorItem clearFix">
								<div class="doctorPhoto">
									<p><img src="../common/images/st01.jpg" alt="院長　南 敬介" /></p>
							...
							<div class="businessItem clearFix">
								<p><img src="../common/images/st02.jpg" width="600" alt="当院スタッフ" /></p>
...
　　　　　　<?php include ('footer.php'); ?>
			...
			<!--		<div class="footerAddress">-->
						<!-- 医院情報（フッター） ここから -->
			<!--			<strong>デンタル クリニック</strong> 東京都新宿区市谷左内町21-13 TEL:03-0000-0000-->
						<!-- 医院情報（フッター） ここまで -->
			<!--		</div>-->
