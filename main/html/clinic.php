...
<html lang="ja">
	...
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1">
		 <!--ページタイトル ここから -->
		<title>医院紹介 | Dental Clinic</title>
		 <!--ページタイトル ここまで -->
			...
			<div id="contentsWrapper">
				<div id="contents" class="clearFix">
					...
					<div id="main">
						...
						<div class="inner">
							<!-- 診療コンセプト ここから -->
							<h3 class="subMidashi"><span class="midashiText">診療コンセプト</span></h3>
							...
							<!-- 休診日・診療案内 ここから -->
							<h3 id="information" class="subMidashi"><span class="midashiText">休診日・診療案内</span></h3>
